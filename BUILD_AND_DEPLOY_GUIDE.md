# DonateChain Build and Deployment Guide

This file keeps the original long-form build, deployment, and theory notes for the mini-project.
Use [README.md](README.md) for the quick overview and
[PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) for the medium-depth project explanation.
...
├── PROJECT_OVERVIEW.md                ← Medium-depth project and feature explanation
├── BUILD_AND_DEPLOY_GUIDE.md          ← This detailed build/deploy guide
├── contracts/
...
└── frontend/
    ...
    ├── dao.html                       ← Governance UI
    ├── history.html                   ← Donor history UI
    ├── about.html                     ← Theory and architecture page
    ├── css/
    │   └── style.css                  ← Shared styling
    └── js/
        ├── config.js                  ← Contract addresses and ABIs
        └── app.js                     ← Shared Web3 and page logic
```
...
STEP 7 ─ Update frontend/js/config.js
          Paste DONATION_CONTRACT_ADDRESS and DAO_CONTRACT_ADDRESS
...
STEP 11 ─ Open the DApp in browser
           http://localhost:8000
           Connect MetaMask → Select campaign → Donate → Sign in MetaMask

STEP 12 ─ View transaction on Etherscan
           https://sepolia.etherscan.io → search tx hash

STEP 13 ─ (Optional) Deploy GovernanceDAO for fund release voting
...
- [ ] Contract addresses pasted in `frontend/js/config.js`
